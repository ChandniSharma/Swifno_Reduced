    ...
    render() {
        return (
            <SafeAreaView forceInset={{ top: 'never', bottom: 'never' }} style={styles.container}>
                <HeaderLoginModule viewName={'View Feedback'} navigation={this.props.navigation} />
                ...
                <View>
                    ...
                    <View style={{ justifyContent: 'space-between', marginLeft: '5%', marginRight: '5%', marginTop: '5%' }}>
                        ...
                        <View style={{ width: 20, width: '30%', marginTop:'5%', marginBottom:'5%' }}>
                            <StarRating
                                // style={{width:30, height:20}}
                                disabled={false}
                                maxStars={5}
                        ...
                        <Text style={commonStyle.textTitleSubmitReview}> Great</Text>
                        <View style={styles.viewSingleLineCell} />
                    </View>
                    {/* </KeyboardAwareScrollView> */}
                    <View style={styles.buttonBigSelected}>
                                        <TouchableOpacity onPress={() => this.props.navigation.navigate('SubmitReview')}>
                                            <Text numberOfLines={2} color={'white'} style={commonStyle.textSelected}>Back</Text>
                                        </TouchableOpacity>
                                    </View>
                </View>
            </SafeAreaView>
